...
State_Stepper_Test::State_Stepper_Test(StateName &name,std::map<EventName,StateName> &state_transitions,Root* root): State(name,state_transitions,root) {

}


EventName State_Stepper_Test::execute() {
