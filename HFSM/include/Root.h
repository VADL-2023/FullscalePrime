...
public:
    ...
    int max_flight_time_ = 120; // TODO: 10 min                                                 // [s] max allowable flight time, if exceeded program ends
    ...
    int length_collect_rafco_ = 30; // TODO CHA4 * 60;                                          // [s] amount of time to collect RAFCO signals and perform image processing
    std::string rafco_freq_ = "144.97M";                                                        // Frequency for RAFCO transmissions
    std::string callsign_ = "KQ4DPB";                                                           // Callsign to look for
    int pds_delay_ = 10 * 1000;                                                                 // [ms] aditional time to wait for PDS
