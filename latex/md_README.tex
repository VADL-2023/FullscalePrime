...
\end{DoxyCode}
 Based on this link\+: \href{https://learnopencv.com/install-opencv-4-on-raspberry-pi/}{\texttt{ https\+://learnopencv.\+com/install-\/opencv-\/4-\/on-\/raspberry-\/pi/}}\hypertarget{md_README_autotoc_md3}{}\doxysection{Other installations}\label{md_README_autotoc_md3}
Since we get pigpio from source, it should automatically compile. You may be missing a few installations here and there, but you should be able to install them with apt.\hypertarget{md_README_autotoc_md4}{}\doxysection{Package Explanations/\+Running the Code}\label{md_README_autotoc_md4}
...
\end{DoxyCode}
\hypertarget{md_README_autotoc_md5}{}\doxysection{Package Explanation}\label{md_README_autotoc_md5}
